...
const GameWindowComponent = () => {
  ...
  const onWheel = (event) => {
    ...
    const stage_x = (mousePointTo.x - stage.getPointerPosition().x / new_scale) * new_scale;
    const stage_y = (mousePointTo.y - stage.getPointerPosition().y / new_scale) * new_scale;
    setStageX(stage_x);
    setStageY(stage_y);
    */
  };
